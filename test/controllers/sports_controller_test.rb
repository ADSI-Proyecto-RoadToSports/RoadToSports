...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { description: @sport.description, modalitie_id: @sport.modalitie_id, name: @sport.name, rule_id: @sport.rule_id }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { description: @sport.description, modalitie_id: @sport.modalitie_id, name: @sport.name, rule_id: @sport.rule_id }
    assert_redirected_to sport_path(assigns(:sport))
  end
